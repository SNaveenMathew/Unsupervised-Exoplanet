...
\lstinputlisting[language=R, firstline=65, lastline=81]{"../main.R"}

\begin{itemize}
\item Model building
\end{itemize}

\lstinputlisting[language=R, firstline=26, lastline=28]{"../main.R"}
\lstinputlisting[language=R, firstline=83, lastline=100]{"../main.R"}
