...
\lstinputlisting[language=R, firstline=67, lastline=80]{"../main.R"}

\begin{itemize}
\item Model building
\end{itemize}

\lstinputlisting[language=R, firstline=161, lastline=163]{"../main.R"}
\lstinputlisting[language=R, firstline=203, lastline=221]{"../main.R"}
